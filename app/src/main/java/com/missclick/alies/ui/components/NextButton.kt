...
fun NextButton(click: () -> Unit){
    ...
    Card(
        ...
        Row(
            ...
            Text(text = context.getString(R.string.next_button).uppercase(), textAlign = TextAlign.Center,
                style = AppTheme.typography.nextButtonText, color = AppTheme.colors.primary)
        }
